...
export class StoriesHomeComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    setInterval(() => {
      this.storiesService.cleanupExpiredStories();
    }, 1000 * 60 * 60);
  }
  ...
  onStoryClick(story: Story): void {
    ...
    this.router.navigate(['/live-tv/view', story.id]).then(success => {
