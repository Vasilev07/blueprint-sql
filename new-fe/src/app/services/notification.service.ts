...
import { UserService, ProfileViewDTO, GetProfileViewStats200Response } from '../../typescript-api-client/src';
...
export class NotificationService implements OnDestroy {
  ...
  private initializeWebSocketListeners(): void {
    this.websocketService.onProfileView()
      .pipe(takeUntil(this.destroy$))
      .subscribe((payload) => {
        console.log('Real-time profile view notification:', payload);
