...
export type SuperLikeNotification =
...
export class SuperLikeNotificationService {
    private superLikeReceivedSubject = new BehaviorSubject<{
        type: "received";
        data: SuperLikeReceivedNotification;
    } | null>(null);
    public superLikeReceived$: Observable<{
        type: "received";
        data: SuperLikeReceivedNotification;
    } | null> = this.superLikeReceivedSubject.asObservable();

    private superLikeSentSubject = new BehaviorSubject<{
        type: "sent";
        data: SuperLikeSentNotification;
    } | null>(null);
    public superLikeSent$: Observable<{
        type: "sent";
        data: SuperLikeSentNotification;
    } | null> = this.superLikeSentSubject.asObservable();
    ...
    private setupSuperLikeNotifications(): void {
        ...
        this.websocketService
            ...
            .subscribe({
                next: (notification) => {
                    console.log(
                        "Super like received notification:",
                        notification,
                    );
                    this.superLikeReceivedSubject.next({
                        type: "received",
                        data: notification,
                    });
                },
        ...
        this.websocketService
            ...
            .subscribe({
                next: (notification) => {
                    console.log(
                        "✅ Super like sent notification received:",
                        notification,
                    );
                    this.superLikeSentSubject.next({
                        type: "sent",
                        data: notification,
                    });
                },
